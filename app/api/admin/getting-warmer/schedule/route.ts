...
import { listSchedule } from "@/lib/getting-warmer/schedule-service";
...
export async function GET() {
  ...
  try {
    ...
    console.error("getting-warmer schedule list failed:", err);
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error("Failed to schedule getting-warmer puzzle:", err);
