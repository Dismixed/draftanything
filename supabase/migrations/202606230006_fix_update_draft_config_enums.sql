-- Cast text RPC params to enum columns in update_draft_config (matches create_draft).
...
begin
  ...
  set
    ...
    draft_type = p_draft_type::public.draft_type,
    picking_mode = p_picking_mode::public.picking_mode,
    judging_mode = p_judging_mode::public.judging_mode,
    ai_personality = p_ai_personality::public.ai_personality,
